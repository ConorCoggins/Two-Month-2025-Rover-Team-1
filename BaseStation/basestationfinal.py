...
class ControlWindow(QWidget):
    def __init__(self, talker_node):
        ...
        wrist_box.addWidget(self.wrist_right)
        wrist_box.addWidget(self.wrist_left)
        main.addWidget(QLabel("<b>Wrist Controls</b>"))
        main.addLayout(wrist_box)

        elbow_box = QHBoxLayout()
        elbow1_box = QVBoxLayout()
        elbow1_box.addWidget(self.lowerelbow_up)
        elbow1_box.addWidget(self.lowerelbow_down)
        elbow2_box = QVBoxLayout()
        elbow2_box.addWidget(self.upperelbow_up)
        elbow2_box.addWidget(self.upperelbow_down)
        elbow_box.addLayout(lowerelbow_box)
        elbow_box.addLayout(upperelbow_box)
